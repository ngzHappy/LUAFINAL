...
static const luaL_Reg myFunctions[]={
    {"printTable",&printTable},
    {"saveTable",&saveTable},
    {"copyTable",&luaL_copyTable},
    {"table2str",&tableToString},
    {nullptr,nullptr}
};

int luaopen_myFunction(lua_State *L) {
    luaL_newlib(L,myFunctions);  /* new module */
    return 1;
}

int register_myFunction(lua_State * L) {
    luaopen_myFunction(L);
    return 1;
}
...
static int pmain (lua_State *L) {
  ...
  /****************************************************/
  luaL_requiref(L,"cct",register_myFunction,1);
  lua_pop(L,1);
  /****************************************************/
